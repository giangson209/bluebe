    ...
    <div class="header-top">
        <div class="container">
            <div class="info-head-top text-center">
                <p>Cùng HA Junior tiếp bước cho trẻ.</p>
                <a href="">
                    <span>Liên hệ ngay</span>
                    <svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M3.83203 10H17.1654" stroke="#E71E25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M12.168 5L17.168 10L12.168 15" stroke="#E71E25" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </a>
            </div>
        </div>
                    ...
                    <div class="h-menu">
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="submenu">
                                    <ul>
                                        <li><a href="tailieu.php">Tài liệu IELTS</a></li> 
                                        <li><a href="tusach.php">Thư viện Sách</a></li> 
                                        <li><a href="biquyet.php">Kỹ năng cho trẻ</a></li> 
                                    </ul>
                                </div>
                            </li>
                            <li>
